 ...
 * <p>
 * NOTE: this is built off of the open source processing <code>PVector</code>
...
public class Vec2 implements Serializable {
	...
	/**
	 * Get the value of this {@link Vec2} at a normalized state (as a unit vector).
	 * NOTE: As this class is <i>immutable, the x and y values in <i>this
	 * {@link Vec2} are not affected or changed.</i>
	 */
	...
	/**
	 * Get the negated version of this {@link Vec2}. NOTE: As this class is
	 * <i>immutable, the x and y values in <i>this {@link Vec2} are not affected or
	 * changed.</i>
	 * 
	...
	/**
	 * Get the distance from this {@link Vec2} to the given other {@link Vec2}.
	 */
	 ...
	 * <p>
	 * As this is an immutable class, the magnitude, x, and y components of this
	 * vector are <i>not</i> affected.
	 */
	 ...
	 *
	 * @param v1 the x and y components of a {@link Vec2}.
	 * @param v2 the x and y components of a {@link Vec2}
	...
	/**
	 * Represents a <i>mutable</i> vector. This differs from {@link Vec2} because
	 * {@link Vec2} is immutable, while this is mutable.
	 * 
	 * @author David Dinkevich
	 */
	public static class Mutable extends Vec2 {
		...
		/**
		 * Set the x and y components of this vector to those of the given vector.
		 * 
		 * @return this mutable vector.
		 */
		...
		/**
		 * Normalize the vector to length 1 (make it a unit vector). As this class is
		 * <i>mutable,</i> the x and y values are modified.
		 * 
		 * @return this mutable vector
		 */
		...
		/**
		 * Negate this vector. As this class is <i>mutable,</i> the x and y values are
		 * modified.
		 * 
		...
		/**
		 * Set the magnitude of this vector. As this class is <i>mutable,</i> the x and
		 * y values are modified.
		 * 
		...
		/**
		 * Linear interpolate this vector to the given vector by the given amount. As
		 * this class is <i>mutable,</i> the x and y values are modified.
		 */
		...
		/**
		 * Rotate the vector by an angle, magnitude remains the same. As this class is
		 * <i>mutable,</i> the x and y values are modified.
		 * 
		...
		/**
		 * Returns the result of adding the given {@link Vec2} to this mutable vector.
		...
		/**
		 * Returns the result of adding this {@link Mutable} {@link Vec2} to the given
		 * float. As this class is <i>mutable,</i> the x and y values are modified.
		 */
		...
		/**
		 * Returns the result of subtracting the given {@link Vec2} from this mutable
		 * vector. As this class is <i>mutable,</i> the x and y values are modified.
		 */
		...
		/**
		 * Returns the result of subtracting the given float from this mutable vector.
		 * As this class is <i>mutable,</i> the x and y values are modified.
		 */
		...
		/**
		 * Returns the result of multiplying this {@link Mutable} {@link Vec2} by the
		 * given {@link Vec2}. As this class is <i>mutable,</i> the x and y values are
		 * modified.
		 */
		...
		/**
		 * Returns the result of multiplying this {@link Mutable} {@link Vec2} by the
		 * given float. As this class is <i>mutable,</i> the x and y values are
		 * modified.
		 */
		...
		/**
		 * Returns the result of dividing this {@link Mutable} {@link Vec2} by the given
		 * {@link Vec2}. As this class is <i>mutable,</i> the x and y values are
		 * modified.
		 */
